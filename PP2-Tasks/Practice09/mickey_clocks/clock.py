...
class MickeyClock:
    def __init__(self, screen_width, screen_height):
        ...
        self.min_hand_orig = pygame.transform.scale(self.min_hand_orig, (150, 250)) # Adjust to fit your clock
        
        self.sec_hand_orig = pygame.image.load(os.path.join(img_dir, "hand_left_centered.png")).convert_alpha()
        self.sec_hand_orig = pygame.transform.scale(self.sec_hand_orig, (190, 240)) # Adjust to fit your clock
